...
|----------|-----------------------|
| Данные, которые получает и передаёт ПЛК | Нарушение целостности (сигнал изменён)
Нарушение достоверности сигнала Сигнал не обработан (пришёл и пропал)  Нарушение доступности|   
